...
# say the athlete is doing a very easy ride --> no intensity for the day, then they will get results of needing very little cho output because did not use that much --> ie will get diet plan to maximize metabolic returns
